...
/**
 * TDProject_Core_Block_Widget_Button_Action_Edit
 *
 * NOTICE OF LICENSE
 *
 ...
 */
class TDProject_Core_Block_Widget_Button_Action_Edit
    ...
    public function __construct(
    	...
    	// set the icon to use
		$this->setIcon('ui-icon-folder-open');
		// set the URL to invoke, when clicked
		$this->setUrl($grid->getEditUrl());
    }
}