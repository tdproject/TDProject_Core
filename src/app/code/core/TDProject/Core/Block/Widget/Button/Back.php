...
/**
 * TDProject_Core_Block_Widget_Button_Back
 *
 * NOTICE OF LICENSE
 *
 ...
 */
class TDProject_Core_Block_Widget_Button_Back
    ...
    public function __construct(
    	...
    	// set the icon to use
		$this->setIcon('ui-icon-folder-collapsed');
		// set the onClick event
		$this->setOnClick(
			'window.location="' . $form->getBackUrl() . '"; return false;'
		);
    }
}