...
require_once 'TDProject/Core/Interfaces/Block/Widget/Grid/Column/Select/Selector.php';
 ...
 */
abstract class TDProject_Core_Block_Widget_Grid_Column_Select_Selector_Abstract
	implements TDProject_Core_Interfaces_Block_Widget_Grid_Column_Select_Selector {
	
	protected $_column = null;
	
	protected $_targetProperty = '';
	
	public function __construct(TDProject_Core_Interfaces_Block_Widget_Grid_Column_Select $column) {
		$this->_column = $column;
	}
	
	/**
	 * (non-PHPdoc)
	 * @see TDProject_Core_Interfaces_Block_Widget_Grid_Column_Select_Selector::getColumn()
	 */
