...
/**
 * TDProject_Core_Block_Widget_Element_Checkbox
 *
 * NOTICE OF LICENSE
 *
 ...
 */
class TDProject_Core_Block_Widget_Element_Input_Checkbox
     ...
     * 
     * @param TDProject_Core_Interfaces_Block_Widget_Form The form instance
     * @return void
     */
    public function __construct(TDProject_Core_Interfaces_Block_Widget_Form $form, $blockName, $blockTitle) {
    	...
    	// set the CSS class
    	$this->_setCssClass('type-check');
        // set the template name
        $this->_setTemplate('www/design/core/templates/widget/element/input/checkbox.phtml');
    }
}