...
/**
 * TDProject_Core_Block_Widget_Element_Textarea
 *
 * NOTICE OF LICENSE
 *
 ...
 */
class TDProject_Core_Block_Widget_Element_Textarea
    ...
    public function __construct(TDProject_Core_Interfaces_Block_Widget_Form $form, $blockName, $blockTitle) {
    	...
    	// set standard width to 400px
    	$this->setWidth(400);
        // set the template name
        $this->_setTemplate(
        	'www/design/core/templates/widget/element/textarea.phtml'
        );
    }
}