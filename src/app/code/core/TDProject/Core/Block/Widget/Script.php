 ...
 */
class TDProject_Core_Block_Widget_Script
    extends TDProject_Core_Block_Widget_Abstract
    implements TDProject_Core_Interfaces_Block_Widget_Script
{
    ...
    public function __construct(
    	TDProject_Core_Interfaces_Block $parent, 
    	$blockName, 
    	$blockTitle) 
    {
        ...
        parent::__construct($this->getParent()->getContext());
    	// set the fieldset name and title
    	$this->_setBlockName($blockName);
    	$this->_setBlockTitle($blockTitle);
    	// set the template
    	$this->_setTemplate('www/design/core/templates/widget/script.phtml');
    }
}