...
/**
 * TDProject_Core_Block_Widget_Element_Input_File
 *
 * NOTICE OF LICENSE
 *
 ...
 */
class TDProject_Core_Block_Widget_Element_Input_File
    ...
    public function __construct(TDProject_Core_Interfaces_Block_Widget_Form $form, $blockName, $blockTitle) {
        ...
        $this->_setTemplate('www/design/core/templates/widget/element/input/file.phtml');
    }
    
    /**
     * Returns the URL to upload files to.
     * 
