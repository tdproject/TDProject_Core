...
/**
 * TDProject_Core_Block_Widget_Element_Textfield
 *
 * NOTICE OF LICENSE
 *
 ...
 */
class TDProject_Core_Block_Widget_Element_Input_Textfield
    ...
    public function __construct(TDProject_Core_Interfaces_Block_Widget_Form $form, $blockName, $blockTitle) {
        ...
        $this->_setTemplate('www/design/core/templates/widget/element/input/textfield.phtml');
    }
}