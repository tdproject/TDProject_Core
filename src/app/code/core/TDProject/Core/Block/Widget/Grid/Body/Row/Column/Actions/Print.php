...
/**
 * TDProject_Core_Block_Widget_Grid_Body_Row_Column_Actions_Print
 *
 * NOTICE OF LICENSE
 *
...
class TDProject_Core_Block_Widget_Grid_Body_Row_Column_Actions_Print
    ...
    public function __construct(
        ...
        $this->_setBlockName(TDProject_Core_Block_Widget_Grid_Body_Row_Column_Actions_Print::BLOCK_NAME);
        $this->_setBlockTitle($action->getLabel());
        $this->_setProperty($action->getProperty());
        $this->_setUrl($action->getUrl());
        // set the template name
        $this->_setTemplate('www/design/core/templates/widget/grid/body/row/column/actions/print.phtml'); 
    }
