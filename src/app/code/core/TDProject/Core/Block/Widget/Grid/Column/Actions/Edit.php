...
/**
 * TDProject_Core_Block_Widget_Grid_Column_Actions_Edit
 *
 * NOTICE OF LICENSE
 *
...
require_once
	'TDProject/Core/Block/Widget/Grid/Body/Row/Column/Actions/Edit.php';
 ...
 */
class TDProject_Core_Block_Widget_Grid_Column_Actions_Edit
    ...
    public function __construct(
    	...
    	$this->_setLabel($this->translate('widget.action.edit'));
    }
    ...
    public function create(
    	...
    	return new
    	    TDProject_Core_Block_Widget_Grid_Body_Row_Column_Actions_Edit(
    	        $column, $this
    	    );
    }
}