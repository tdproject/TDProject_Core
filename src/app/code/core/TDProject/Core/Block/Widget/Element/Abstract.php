...
abstract class TDProject_Core_Block_Widget_Element_Abstract
    ...
    /**
     * The width of the input element to be rendered.
    ...
    /**
     * Flag to mark the element disabled.
    ...
    /**
     * Renders an element in the specific width.
	 *
     * @param int $width
     * 		The width in pixel.
     * @return TDProject_Core_Interfaces_Block_Widget_Element
     * 		The element instance
     */
    public function setWidth($width = 220)
    {
    	$this->_width = new TechDivision_Lang_Integer($width);
    	return $this;
    }
    
    /**
     * (non-PHPdoc)
     * @see TDProject_Core_Interfaces_Block_Widget_Element::getForm()
     */
    ...
    /**
     * (non-PHPdoc)
     * @see TDProject_Core_Interfaces_Block_Widget_Element::getWidth()
     */
