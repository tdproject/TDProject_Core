...
/**
 * TDProject_Core_Block_Widget_Grid_Column_Actions_View
 *
 * NOTICE OF LICENSE
 *
...
require_once
	'TDProject/Core/Block/Widget/Grid/Body/Row/Column/Actions/View.php';
 ...
 */
class TDProject_Core_Block_Widget_Grid_Column_Actions_View
    ...
    public function __construct(
    	...
    	$this->_setLabel($this->translate('widget.action.view'));
    }
    ...
    public function create(
    	...
    	return new
    	    TDProject_Core_Block_Widget_Grid_Body_Row_Column_Actions_View(
    	        $column, $this
    	    );
    }
}