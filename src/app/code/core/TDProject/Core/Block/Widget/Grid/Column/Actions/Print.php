...
/**
 * TDProject_Core_Block_Widget_Grid_Column_Actions_Print
 *
 * NOTICE OF LICENSE
 *
...
require_once
	'TDProject/Core/Block/Widget/Grid/Body/Row/Column/Actions/Print.php';
...
class TDProject_Core_Block_Widget_Grid_Column_Actions_Print
    ...
    public function __construct(
    	...
    	$this->_setLabel($this->translate('widget.action.print'));
    }
